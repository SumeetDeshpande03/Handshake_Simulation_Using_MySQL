...
class EditExperienceForm extends React.Component {
  constructor() {
    super();
    this.state = {company_name: '', designation: '', starting_date: '', ending_date: '', company_location: '' , work_summary: ''};
  }
  ...
  onSave = (e) => {
    ...
    axios
      .put(`http://35.166.32.0:8080/api/student/experience/${id}`, data, {headers: {'Content-Type': 'application/json'}})
      .then(res => {
          console.log(res)
        if (res.status === 200) {
        ...
        <div>
          ...
          <div class='field'>
            ...
            <div class='field'>
                ...
                <input type="text" value={this.state.cgpa} placeholder="Work Summary" onChange={this.onChangeHandlerWorkSummary} />
            </div>
            <div>
