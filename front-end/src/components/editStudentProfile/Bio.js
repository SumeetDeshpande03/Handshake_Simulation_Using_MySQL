...
class Bio extends React.Component {
  ...
  renderModal = () => {
    ...
    return (
      <Modal trigger={<label htmlFor="icon-button-file">
      ...
      <Modal.Content image>
        ...
        <Modal.Description>
          ...
          <input accept="image/*" className={this.useStyles.input} id="contained-button-file" multiple type="file" onChange={this.onFileSelect} />
          ...
          <Button2 variant="contained" color="primary" style={{marginRight: '10px'}} onClick={this.onSaveImage}>
            Save
        </Button2>
      ...
      <div class='ui raised cards'>
        <div class='card'>
          ...
          <i className='pencil alternate icon' style={{ float: 'right' }}></i>
            <div class='header'>{this.props.bio.student_name}</div>
            <div class='meta'>
            </div>
            <div class='description'>
              {this.props.bio.student_college_name}<br></br>
              Location: {this.props.bio.city_name} | {this.props.bio.state_name}
            </div>
          </div>
        </div>
      </div>
